import os
import sys
# 导入sys模块，使用sys.modules获取模块中的所有内容，类似反射的功能
import collections

# 这个表示从UserDict类中导入UserDict，类似于Java中的 import UserDict.UserDict
...
class FileInfo(collections):
    ...
    def __init__(self, filename=None):
        collections.__init__(self)  # 初始化父类
...
if __name__ == "__main__":  # main函数，在别的模块中不会允许这里面的代码了
    for info in listDirectory("D:\下载\baidu\王煜全\2016年\2016年06月\6.15", [".mp3"]):  # 循环获取E:\\Music文件夹中所有的mp3文件的信息
